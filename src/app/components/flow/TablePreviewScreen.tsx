...
export function TablePreviewScreen({ onJoinTable, onBack }: TablePreviewScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="px-6 pt-6 pb-4 flex items-center justify-between md:px-8 md:pt-10">
      ...
      {/* Scrollable content */}
      <div className="flex-1 overflow-y-auto px-6 pb-32 md:px-8 md:pb-40">
        <motion.div
        ...
        >
          ...
          <div className="mb-8 max-w-3xl">
            ...
            <h1 className="text-[40px] leading-[1.1] tracking-[-0.01em] mb-3 md:text-[60px]" style={{ fontFamily: 'Cormorant, serif', fontWeight: 400 }}>
              Sunday morning
              <br />
              writers
            </h1>
